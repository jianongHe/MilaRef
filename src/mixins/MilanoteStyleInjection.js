...
const CSSInjections = {
    ...
    [hideToolbarKey]: '#toolbar{display: none} .ElementToolDraggable {width: 20px;} .tool-list{width: 30px;}',
    [viewportKey]: '#canvas-viewport{scrollbar-width: none;}',
    [headerFloatingKey]: 'header.AppHeader{position: absolute; top: 0; width: 100%;}',
